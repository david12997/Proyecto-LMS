<?php
        ...
        //esta funcion imprime la interfaz grafica de los cursos buscados
        function Imprimir_curso_buscado($res,$numres){
            ...
            for ($i=0; $i < $numres; $i++) { 
              ...
              echo  '
                  ...
                  <div class="card m-4 mt-5 '.$res[$i]["estado"].'" style="width: 18rem;">
            <img src="../../'.$res[$i]["ruta_icono"].'" class="card-img-top" alt="...">
            <div class="card-body">
            <h5 class="card-title">'.$res[$i]["nombre"].'</h5>
             
            </div>
            <ul class="list-group list-group-flush">
            <li class="list-group-item">Descripcion: '.$res[$i]["descripcion_curso"].'</li>
            <li class="list-group-item">Duracion: '.$res[$i]["duracion_curso"].' horas</li>
            <li class="list-group-item">Precio: '.$res[$i]["precio_curso"].' pesos cop</li>
            </ul>
            <div class="card-body">
            <a href="#" class="card-link btn btn-block btn-primary"><h5>Ver demo</h5></a>
            <br>
            <a href="../../logica-negocio/estudiante/inscribir-curso.php?curso='.$res[$i]['id_curso'].'&estudiante='.$_SESSION['data']['id'].'" class="card-link btn btn-block btn-success"><h5>Inscribirme</h5></a>
            </div>
            </div>
        ...
        <li class="list-group-item"><a href="#" class="btn btn-block btn-primary">Resolver taller o ejercico</a></li>
            ...
            header('location:index.php?error=No se encontraron resultados para tu busqueda');
        }
